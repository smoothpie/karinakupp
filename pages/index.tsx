      ...
      <main className={styles.main}>
        <section className={styles.header}>
          ...
          <div className={styles.info}>
            ...
            <p className={styles.description}>I'm a software engineer with 6 years of experience. I spent 3 years building mostly MVPs for startups at an outsourcing company, then left and did some freelance (like building a medical tourism platform...during a global pandemic), and in 2022, launched Chill Subs - a website helping writers get published that now has almost 20,000 registered users and is reimagining the writing industry every day.</p>
